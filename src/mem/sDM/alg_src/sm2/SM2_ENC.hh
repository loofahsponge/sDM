...
namespace gem5
{
    namespace sm2
    {
        ...
        int SM2_Encrypt(unsigned char *randK, epoint *pubKey, unsigned char M[],unsigned int klen, unsigned char C[]);
        int SM2_Decrypt(big dB, unsigned char C[], unsigned int Clen, unsigned char M[]);
        extern int SM2_ENC_SelfTest();
        extern const unsigned char SM2_p[32],SM2_a[32],SM2_b[32],SM2_Gx[32],SM2_Gy[32],SM2_h[32],SM2_n[32];
