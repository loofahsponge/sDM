...
public:
    ...
    Flash& operator--()      {fincr(fn,-1,1,fn); return *this;}
    Flash& operator+=(const Flash& f) {mr_fadd(fn,f.fn,fn);  return *this;}

    Flash& operator-=(const Flash& f) {mr_fsub(fn,f.fn,fn);  return *this;}

    Flash& operator*=(const Flash& f) {mr_fmul(fn,f.fn,fn);  return *this;}
    Flash& operator*=(int n)          {fpmul(fn,n,1,fn);  return *this;}


    Flash& operator/=(const Flash& f) {mr_fdiv(fn,f.fn,fn);  return *this;}
