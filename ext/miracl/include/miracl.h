...
extern void  mr_fmul(_MIPT_ flash,flash,flash);      
extern void  mr_fdiv(_MIPT_ flash,flash,flash);      
extern void  mr_fadd(_MIPT_ flash,flash,flash);      
extern void  mr_fsub(_MIPT_ flash,flash,flash);      
